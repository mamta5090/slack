    ...
    <div className="min-h-screen flex flex-col bg-[#0b0b0b]">
      ...
      <div className="h-14 bg-[#4a1f4a] flex items-center px-4">
        <div className="hidden sm:flex items-center gap-3">
          <button className="p-1 rounded hover:bg-black/10 text-white">⟵</button>
          <button className="p-1 rounded hover:bg-black/10 text-white">⟶</button>
        </div>
          ...
          <div className="max-w-[1150px] mx-auto px-6 py-6">
            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <div className="text-sm text-gray-500 mt-1">Messages &nbsp;•&nbsp; Add canvas</div>
              </div>

              <div className="flex items-center gap-3">
                <button className="px-3 py-2 rounded border text-sm">Invite teammates</button>
                <button className="px-3 py-2 rounded border text-sm">Huddle ▾</button>
            ...
            <div className="bg-white rounded-md">
              <h2 className="text-3xl font-extrabold mb-2">👋 Welcome to your first channel!</h2>
              ...
              <div className="mt-4 border rounded-md">
                ...
                <div className="flex items-center gap-3 px-3 py-2 border-b bg-gray-50">
                  ...
                  <button className="text-sm px-2 py-1 rounded hover:bg-gray-100">•</button>
                  <div className="flex-1" />
                  <button className="text-sm px-2 py-1 rounded hover:bg-gray-100">Today ▾</button>
                </div>
